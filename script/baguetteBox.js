...
!(function(t, e) {
  ...
  function e(t, e) {
    var n = document.querySelectorAll(t),
      o = { galleries: [], nodeList: n };
    (U[t] = o),
      [].forEach.call(n, function(t) {
        e && e.filter && (V = e.filter);
        var n = [];
        if (
          ((n = "A" === t.tagName ? [t] : t.getElementsByTagName("a")),
          (n = [].filter.call(n, function(t) {
  ...
  function i() {
    return (S = T("baguetteBox-overlay"))
      ...
      : ((S = N("div")),
        ...
        (P = N("div")),
        (P.id = "baguetteBox-slider"),
        S.appendChild(P),
        (F = N("button")),
        F.setAttribute("type", "button"),
        (F.id = "previous-button"),
        F.setAttribute("aria-label", "Previous"),
        (F.innerHTML = M.svg ? I : "&lt;"),
        S.appendChild(F),
        (H = N("button")),
        ...
        (L.innerHTML = M.svg ? q : "&times;"),
        S.appendChild(L),
        (F.className = H.className = L.className = "baguetteBox-button"),
        void r());
  }
  function a(t) {
    switch (t.keyCode) {
  ...
  function c(t) {
    j.noScrollbars &&
      ...
      "block" !== S.style.display &&
        ...
        j.onChange && j.onChange(z, W.length),
